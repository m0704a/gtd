package hu.pnt.gtd.repository;

import hu.pnt.gtd.GtdApp;
import hu.pnt.gtd.config.Constants;
import hu.pnt.gtd.config.audit.AuditEventConverter;
import hu.pnt.gtd.domain.PersistentAuditEvent;
...
import static hu.pnt.gtd.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
