package hu.pnt.gtd.web.rest;

import hu.pnt.gtd.GtdApp;
import hu.pnt.gtd.config.Constants;
import hu.pnt.gtd.domain.Authority;
import hu.pnt.gtd.domain.User;
import hu.pnt.gtd.repository.AuthorityRepository;
import hu.pnt.gtd.repository.UserRepository;
import hu.pnt.gtd.security.AuthoritiesConstants;
import hu.pnt.gtd.service.MailService;
import hu.pnt.gtd.service.UserService;
import hu.pnt.gtd.service.dto.PasswordChangeDTO;
import hu.pnt.gtd.service.dto.UserDTO;
import hu.pnt.gtd.web.rest.errors.ExceptionTranslator;
import hu.pnt.gtd.web.rest.vm.KeyAndPasswordVM;
import hu.pnt.gtd.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = GtdApp.class)
